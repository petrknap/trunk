...
publish: tests
	...
	git subsplit publish --heads=master --update "packages/Enum:git@github.com:petrknap/php-enum.git packages/ServiceManager:git@github.com:petrknap/php-servicemanager.git packages/Singleton:git@github.com:petrknap/php-singleton.git"
	rm -rf .subsplit
